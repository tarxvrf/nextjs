    ...
    <div className=" max-w-6xl mx-auto sm:px-20 px-2 pt-2 sm:pt-20 ">
      <div key={data.data.id}>
            ...
            <figure className="">
              <Image
                ...
                src={
                  data.data.foto1 === ""
                    ? `/images/window.svg`
                    : `https://go-download.up.railway.app/${data.data.foto1}`
                }
              />
            </figure>
            ...
            <figure className="">
              <Image
                ...
                src={
                  data.data.foto2 === ""
                    ? `/images/window.svg`
                    : `https://go-download.up.railway.app/${data.data.foto2}`
                }
              />
            </figure>
            <div className="card-body">
            ...
            <figure className="">
              <Image
                ...
                src={
                  data.data.foto3 === ""
                    ? `/images/window.svg`
                    : `https://go-download.up.railway.app/${data.data.foto3}`
                }
              />
            </figure>
            <div className="card-body">
        ...
        <div className="pb-3 border py-2 px-2 rounded-xl shadow-lg">
          <div className="card  ">
            <label>
              Nama Lokasi : <span>{data.data.namalokasi}</span>{" "}
            </label>
            <h2>
            ...
            <h2>
              <span className="font-bold">Sistem Parkir :</span>
              {data.data.sistemparkir}
            </h2>
            <h2>
              <span className="font-bold">Akhir Kontrak : </span>
              {data.data.kontrak}
            </h2>
            <h2>
              <span className="font-bold">Kondiisi Lokasi : </span>
              {data.data.kondisi}
            </h2>
            <h1>
              <span className="font-bold">Jumlah Pos Motor : </span> <br />
              <span className="font-bold"> Jumlah Pos Mobil :</span>
              <br />
              <span className="font-bold">PM :</span> {data.data.pm} ||{" "}
              <span className="font-bold">PK:</span> {data.data.pk}
            </h1>
            <div className="grid sm:grid-cols-3 gap-2 py-4 px-2 justify-center">
              <div className="border rounded-lg p-3 w-full bg-white shadow-sm">
                ...
                <p className="break-words">{data.data.fu1}</p>
              </div>
              <div className="border rounded-lg p-3 w-full bg-white shadow-sm">
                <label className="label">FollowUp 2</label>
                <p className="break-words">{data.data.fu2}</p>
              </div>
              <div className="border rounded-lg p-3 w-full bg-white shadow-sm">
